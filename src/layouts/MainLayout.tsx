...
export function MainLayout() {
  return (
    <div className="relative min-h-screen overflow-x-hidden bg-surface dark:bg-zinc-950">
      <AmbientBackground />
      <div className="relative z-10 mx-auto max-w-6xl px-4 pb-16 pt-20 md:px-8 md:pb-24 md:pt-24">
